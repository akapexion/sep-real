          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {stats.map((stat, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-b from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center hover:shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all"
              >
                <div className="text-cyan-400 mb-3 flex justify-center">
                  {stat.icon}
                </div>
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-cyan-400 to-blue-500 text-transparent bg-clip-text">
                  {stat.number}
                </h3>
      ...
      <section className="py-12 sm:py-16 md:py-24 relative z-10">
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 md:px-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="bg-gradient-to-b from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-2xl p-8 hover:shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all"
            >
              <Dumbbell className="w-10 h-10 text-cyan-400 mb-4 mx-auto" />
              <h3 className="text-xl font-semibold mb-3 text-cyan-400 text-center">
            ...
            <motion.div
              ...
              className="bg-gradient-to-b from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-2xl p-8 hover:shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all"
            >
              <Zap className="w-10 h-10 text-cyan-500 mb-4 mx-auto" />
              <h3 className="text-xl font-semibold mb-3 text-cyan-500 text-center">
